...
<body>
    ...
    <!-- 배경에 쓰일 이미지 URL 지정-->
    <img src="/images/others/pexels-kelly-2888333.jpg" style="border: 1px solid black; width: 100%; height: 700px;">
 		
 		<div style="left: 200px; width: 600px; bottom: 250px; font-size:1.2em; font-weight: bold; 
